...
# Карта предметных направлений

Программа организована в три группы: инженерный фундамент, технические
направления и интегрирующее направление leadership/architecture. Предметное
направление — не список библиотек, а область инженерной практики, включающая
проектирование, реализацию, эксплуатацию и диагностику. Во внутренних metadata
для направления используется имя `track`.
...
Это направление начинается не после остальных, а идёт параллельно. Оно регулярно использует кейсы и проекты из B1–B11.

## Размещение исходно названных технологий

| Технология | Основное направление | Связанные направления |
|---|---|---|
